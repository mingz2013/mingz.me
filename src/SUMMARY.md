...
* [design patterns](./design-patterns/README.md)
    - [策略模式(Strategy Pattern)](./design-patterns/strategy-pattern.md)
    - [观察者模式(Observer)](./design-patterns/observer-pattern.md)
    - [装饰者模式(Decorator Pattern)](./design-patterns/decorator-pattern.md)
    - [工厂方法模式(Factory Pattern)](./design-patterns/factory-pattern.md)
    - [抽象工厂模式（Abstract Factory Pattern）](./design-patterns/abstract-factory-pattern.md)
    - [单件模式(Singleton Pattern)](./design-patterns/singleton-pattern.md)
    - [命令模式(Command Pattern)](./design-patterns/command-pattern.md)
    - [适配器模式(Adapter Pattern)](./design-patterns/adapter-pattern.md)
    - [外观者模式(Facade Pattern)](./design-patterns/facade-pattern.md)
    - [模板方法模式(Template Method Pattern)](./design-patterns/template-method-pattern.md)
    - [迭代器模式(Iterator Pattern)](./design-patterns/iterator-pattern.md)
    - [组合模式(Composite Pattern)](./design-patterns/composite-pattern.md)
    - [状态模式(State Pattern)](./design-patterns/state-pattern.md)
    - [代理模式(Proxy Pattern)](./design-patterns/proxy-pattern.md)
    - [复合模式(compound pattern)](./design-patterns/compound-pattern.md)
        - [MVC(Model-View-Controller)](./design-patterns/mvc-pattern.md)
    
    - [桥接](./design-patterns/bridge-pattern.md)
    - [生成器模式](./design-patterns/builder-pattern.md)
    - [责任链](./design-patterns/chain-of-responsibility-pattern.md)
    - [蝇量](./design-patterns/flyweight-pattern.md)
    - [解释器](./design-patterns/interpreter-pattern.md)
    - [中介者](./design-patterns/mediator-pattern.md)
    - [备忘录](./design-patterns/memento-pattern.md)
    - [原型](./design-patterns/prototype-pattern.md)
    - [访问者](./design-patterns/visitor-pattern.md)
